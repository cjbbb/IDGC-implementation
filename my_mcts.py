...
from utils.Configures import mcts_args
...
if __name__ == "__main__":
    ...
    checkpoint = torch.load("./checkpoint/BA_2Motifs/gin_best.pth")
    ...
    for i in batch_indices:
        ...
        for j in range(10):
            ...
            plotutils.plot(
                ...
                coalition,
                x=data.x,
                figname=os.path.join(save_dir, f"example_{i*10+j}_{data.y}.png"),
            )
            print(data.y)
